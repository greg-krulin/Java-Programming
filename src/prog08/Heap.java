...
public class Heap <E> extends AbstractQueue<E> {
  ...
  public E poll() {
    ...
    while(( getRight(index) < size() && (compare(index, getRight(index) ) > 0) ) || ( getLeft(index) < size() && (compare(index, getLeft(index)) > 0 ) ) ) {
  ...
  public boolean remove (Object o) {
    ...
    // item at index.
    	...
    	E bottom = theData.get( size() - 1);
    	theData.set(index, bottom);
